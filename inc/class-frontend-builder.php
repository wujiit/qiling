...
class Frontend_Builder {
        ...
        wp_localize_script(
            ...
            array(
                ...
                'texts'            => array(
                    ...
                    'settingsPanelDesc'  => __( '这里只改当前模块，适合做局部微调；不改时会继续跟着当前页。', 'developer-starter' ),
                    'pageSettingsEntry' => __( '页面设置', 'developer-starter' ),
                    'pageSettingsPanelTitle' => __( '页面设置', 'developer-starter' ),
                    'pageSettingsPanelDesc' => __( '这里管理当前页的模板、页头和当前页单独风格；模块里还能继续做局部微调。', 'developer-starter' ),
                    ...
                    'pageDesignHelp' => __( '这里写了只影响当前页；不写就继续跟着全站。', 'developer-starter' ),
                    'pageDarkPaletteSectionHelp' => __( '这里只在当前页的暗色状态生效；不填就继续跟着全站暗色方案。', 'developer-starter' ),
                    'pageStructureSectionHelp' => __( '当前页想单独改圆角和动效，就在这里改；不填继续跟随全站。', 'developer-starter' ),
                    ...
                    'pageDesignResetGroupDone' => __( '已清空当前分组，保存后继续跟随全站。', 'developer-starter' ),
                    ...
                    'pageSettingInherited' => __( '留空就是继续跟着全局', 'developer-starter' ),
                    'pageTypographySectionHelp' => __( '当前页想单独改正文、标题、按钮、导航排版，就在这里改；不填继续跟随全站。', 'developer-starter' ),
                    'pageSettingLayoutHelp' => __( '当前页想单独改容器宽度、区块间距和布局模式，就在这里改。', 'developer-starter' ),
                    'pageComponentSectionHelp' => __( '这里只改当前页组件外观，不影响全站；模块里仍可继续微调。', 'developer-starter' ),
                    ...
                    'pageGovernancePageDesc' => __( '这里写的内容只影响当前页；不写就继续跟随全站。', 'developer-starter' ),
                    ...
                    'moduleGovernancePageDesc' => __( '当前页的单独风格会继续传给这个模块。', 'developer-starter' ),
                    'moduleGovernanceModuleDesc' => __( '这里的设置只改当前模块，最适合做局部强调。', 'developer-starter' ),
                    'moduleGovernanceNote' => __( '不填就继续跟着当前页和全站。', 'developer-starter' ),
                    'moduleLegacyBridgeNote' => __( '该模块的旧公共样式已经并到这里，后续直接在当前面板调整就行。', 'developer-starter' ),
                    'moduleVisualTip' => __( '只影响当前模块，优先级高于页面风格；留空字段继续继承页面或全站。', 'developer-starter' ),
                    ...
                    'moduleVisualCleared' => __( '已清空当前模块视觉设置，保存后继续继承页面风格。', 'developer-starter' ),
                    'aiPanelTitle'       => __( 'AI装修', 'developer-starter' ),
                    'aiPanelDesc'        => __( '当前只支持单页草稿、当前模块优化和 SEO 辅助，不在线生成整站', 'developer-starter' ),
                    ...
                    'aiPromptRecipeApplied' => __( '已追加快捷需求，可继续补充细节。', 'developer-starter' ),
                    ...
                    'aiPromptRecipeModuleText' => __( '只优化当前选中的模块：保留模块类型和信息结构，强化标题、描述、按钮文案和视觉节奏，不新增无关字段。', 'developer-starter' ),
    ...
    public function ajax_restore_snapshot() {
        ...
        if ( $data_source !== $current_source ) {
            wp_send_json_error( array( 'message' => __( '该快照来源与当前页面装修数据源不一致，无法恢复。', 'developer-starter' ) ), 400 );
        }
