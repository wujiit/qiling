    ...
    private function get_fields_config() {
        ...
        return array(
            ...
            'footer' => array(
                ...
                array( 'id' => 'footer_visual_wave_layer_opacity', 'type' => 'number', 'label' => __( '副波浪透明度', 'developer-starter' ), 'default' => '0.38', 'attrs' => array( 'min' => '0', 'max' => '1', 'step' => 'any' ), 'desc' => __( '请输入 0 到 1 之间的任意小数，例如 0.35、0.37 或 0.4；超出范围的值会被限制到有效范围。', 'developer-starter' ) ),
