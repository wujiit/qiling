...
class Design_Tokens {
    ...
    public static function build_root_css() {
        ...
        if ( self::is_global_tokens_enabled( $options ) ) {
            ...
            $css .= ".card,.news-card,.product-card,.case-card,.pricing-card,.faq-item,.team-member,.about-culture-card,.about-gallery-item,.timeline-content,.account-section,.module-services .service-item,.module-features .feature-item,.search-overlay-inner{border-radius:var(--qiling-card-radius);}\n";
    ...
    private static function build_component_css() {
        ...
        $form_selector = "input:not(.header-search-input):not([type='checkbox']):not([type='radio']):not([type='submit']):not([type='button']):not([type='reset']):not([type='range']):not([type='file']),select,textarea,.search-overlay .search-form input,.contact-form input,.contact-form textarea,.contact-form select,.comment-form input[type='text'],.comment-form input[type='email'],.comment-form textarea";
