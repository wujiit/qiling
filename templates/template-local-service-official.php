...
<div class="page-template template-local-service-official">
    <?php if ( $has_modules ) : ?>
    ...
    <?php else : ?>
        <section class="section-padding" style="min-height: 60vh; display: flex; align-items: center; justify-content: center; background: linear-gradient(135deg, #0f172a 0%, #2563eb 100%);">
            <div class="container text-center">
                <div style="font-size: 3rem; margin-bottom: 20px;">SRV</div>
                <h2 style="color: #fff; font-size: 2rem; margin-bottom: 20px;"><?php esc_html_e( '本地生活服务官网页', 'developer-starter' ); ?></h2>
                <p style="color: rgba(255,255,255,0.85); margin-bottom: 24px; font-size: 1.05rem;">
                    <?php esc_html_e( '保存页面后会自动填充本地服务模块，可继续编辑服务项目、门店范围、保障承诺和预约入口。', 'developer-starter' ); ?>
                </p>
