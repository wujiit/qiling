...
<div class="page-template template-open-source-devtools">
    <?php if ( $has_modules ) : ?>
    ...
    <?php else : ?>
        <section class="section-padding" style="min-height: 60vh; display: flex; align-items: center; justify-content: center; background: linear-gradient(135deg, #0b1220 0%, #1e3a8a 100%);">
            <div class="container text-center">
                ...
                <h2 style="color: #fff; font-size: 2rem; margin-bottom: 20px;"><?php esc_html_e( '开源项目/开发工具官网', 'developer-starter' ); ?></h2>
                <p style="color: rgba(255,255,255,0.85); margin-bottom: 24px; font-size: 1.05rem;">
                    <?php esc_html_e( '保存页面后会自动填充开源工具官网模块，你可以继续自由编辑快速开始、下载入口和版本路线。', 'developer-starter' ); ?>
                </p>
